...
public class SlackBot extends Bot {
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
        ...
        String newMessage = Dico.getNewOopsedTitle(message);
        if(newMessage != null){
        	System.out.print("lol "+message);
        	reply(session, event, new Message(newMessage));
        }
    }
    ...
    public void onPinAdded(WebSocketSession session, Event event) {
        reply(session, event, new Message("Arrête de piner"));
    }
    ...
    public void onFileShared(WebSocketSession session, Event event) {
        logger.info("C'est quoi ce fichier?", event);
    }
